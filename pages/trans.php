  ...
  <div class="container my-4">
    ...
    <p class="font-weight-bold">An example of bootstrap tabs responsive. Easy to implement and customize. Examples of basic and advanced usage.</p>

    <p><strong>Detailed documentation and more examples you can find in our <a href="https://mdbootstrap.com/docs/standard/navigation/tabs/"
          target="_blank">Bootstrap Tabs Docs</a> </p>
  ...
  <hr class="mb-5"/>
    ...
    <p class="font-weight-bold">Basic examples</p>
          ...
          <div class="col-xl-6 mb-4 mb-xl-0">
            ...
            <!-- Description -->
            <p class="mb-4">Default styling for Bootstrap Tabs component</p>
          ...
          <div class="col-xl-6">
            ...
            <h2 class="secondary-heading">
              Material tabs
              <a href="https://mdbootstrap.com/docs/standard/pro/" target="_blank" class="btn btn-danger btn-sm waves-effect waves-light" role="button">MDB
                Pro component

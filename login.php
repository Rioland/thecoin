    ...
    <section class="regsec1">
        ...
        <div class="midd">
            <div class="boxx">
                ...
                <div class="forggclaz">
                    <a href="#" class="forgstyle">Forgot your password?</a><br><br>
    
                    <a href="#" class="forgstyle2">Old Students/Staff only click Here to Register</a><br><br>
    
                    <a href="#" class="forgstyle3">Resend email confirmation</a><br><br>
    
                    <a href="./index.html" class="forgstyle4">Back to home page</a>
